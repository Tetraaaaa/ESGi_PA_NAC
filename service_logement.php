...
if (!isset($_GET['logement_id']) || empty($_GET['logement_id'])) {
...
$stmt = $bdd->prepare("
    ...
    WHERE SELECTIONNE.id_logement = :id_logement
");
$stmt->bindParam(':id_logement', $logement_id, PDO::PARAM_INT);
$stmt->execute();
    ...
    <main class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p><?php echo $translations['Informations sur les services liés au logement actuel.']; ?></p>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <?php if ($service['status'] !== 'Termine' && $service['status'] !== 'demande envoyée'): ?>
                                    <a href="consulter_demande_client.php?id_service=<?php echo htmlspecialchars($service['service_id']); ?>&id_logement=<?php echo htmlspecialchars($logement_id); ?>" class="btn btn-primary">Consulter</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
                ...
                if(serviceId) {
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            var url = 'selectionne_service_logement.php?id_service=' + serviceId + '&logement_id=' + '<?php echo $logement_id; ?>';
