                ...
                if ($locations) {
                    ...
                    foreach ($locations as $location) {
                        ...
                        foreach ($logements as $logement) {
                            ...
                            echo '<button class="btn btn-primary" onclick="window.location.href=\'consulter_location_client.php?id=' . $location['id'] . '\'">' . (isset($translations['Consulter']) ? $translations['Consulter'] : 'Consulter') . '</button>';
                            echo '</div>';
                            echo '</div>';
                        }
                    }
