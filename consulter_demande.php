...
<body>
    ...
    <main class="container mt-4">
        <div class="row">
            <div class="col-md-6">
                <h2>Consulter Demande</h2>
                <div class="action-buttons">
                    <a href="creer_intervention.php?id_service=<?php echo htmlspecialchars($id_service); ?>&id_location=<?php echo htmlspecialchars($id_location); ?>&id_logement=<?php echo htmlspecialchars($id_logement); ?>" class="btn btn-secondary">Créer une intervention</a>
                    <a href="creer_facture.php?id_service=<?php echo htmlspecialchars($id_service); ?>&id_location=<?php echo htmlspecialchars($id_location); ?>&id_logement=<?php echo htmlspecialchars($id_logement); ?>" class="btn btn-secondary">Créer une facture</a>
                    <button class="btn btn-danger" id="terminerService">Mettre fin au service</button>
                </div>
                <div class="card mb-4">
                    <div class="card-body">
    ...
    $(document).ready(function() {
        ...
        $('#terminerService').on('click', function() {
            $.post('terminer_service.php', {
                ...
                if (res.success) {
                    alert('Service terminé avec succès.');
                    location.reload();
                } else {
