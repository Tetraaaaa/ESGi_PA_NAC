    ...
    <div class="row">
      <?php
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
          ...
          echo '<a href="supprimer_logement.php?id=' . $row['id'] . '" class="btn btn-danger" onclick="return confirm(\'' . $translations['Êtes-vous sûr de vouloir supprimer ce logement ?'] . '\');">' . $translations['Supprimer'] . '</a>';
          echo '</div>';
          echo '</div>';
          echo '</div>';
          echo '</div>';
