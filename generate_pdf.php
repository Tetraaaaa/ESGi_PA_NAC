...
require_once 'include/connection_db.php'; // Inclure la connexion à la base de données

// Vérifiez si le dossier "factures" existe, sinon créez-le
...
// Ajout des informations de la facture au PDF
...
// Insérer les informations dans la table FACTURE
try {
    $stmt = $bdd->prepare("
