...
if (!isset($_GET['id_service']) || !isset($_GET['id_location'])) {
    echo '<p>Erreur : ID de service ou ID de location manquant.</p>';
    exit;
}
...
<body>
    ...
    <main class="container mt-4">
        ...
        <form action="selectionne_service_verif.php" method="POST" class="mt-4">
            <div class="mb-3">
